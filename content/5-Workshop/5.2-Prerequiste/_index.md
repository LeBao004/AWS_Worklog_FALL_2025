...
Before starting this workshop, you need to create an IAM role with the following permissions:

1. Navigate to IAM Console
2. Create a new IAM role for Lambda
3. Attach the following policies:
   - **AmazonBedrockFullAccess** - Required to invoke Bedrock models
   - **CloudWatchLogsFullAccess** - Required for Lambda logging

#### AWS Account Requirements

- Active AWS Account
- Access to Amazon Bedrock (available in us-east-1, us-west-2, or other supported regions)
- Permissions to create Lambda functions, API Gateway, and S3 buckets
...
Let's get started with setting up Amazon Bedrock!
```
{
    "Version": "2012-10-17",
    "Statement": [
